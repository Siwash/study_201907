package rpf.study.kafka.consumer;
...
import rpf.study.kafka.socket.WebSocketServerHandler;
...
public class KafkaConsumerServer implements MessageListener<String, String> {
    ...
    public void onMessage(ConsumerRecord<String, String> record) {
        ...
        boolean b = webSocketServerHandler.sendMessageToAll(value);
